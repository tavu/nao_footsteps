...
public:
   ...
   */
  Footstep(double x, double y, double theta, float w,
           double cell_size, int num_angle_bins, int max_hash_size, double dif_angle_cost);
  ~Footstep();
