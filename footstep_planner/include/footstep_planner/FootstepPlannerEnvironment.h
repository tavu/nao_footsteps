...
//   int getHvalue(int id1 ,int id2) const;
  /**
...
//   int  stepCost(const PlanningState& a, const PlanningState& b, float cost=1);
  ...
  int costFromFootstep(const Footstep &f) const;
};
}
